...
requirements apply to the generated data. Run from the repository root:
    python3 scripts/refresh_iau_stars.py
"""
import html
import json
import re
...
def main():
    ...
    output = Path(__file__).resolve().parents[1] / "data" / "iau-named-stars.js"
