...
const view: FramingView = {
  ...
  centering: { toleranceArcminutes: .5, maxCorrections: 4, correction: 1, outcome: 'working', measurements: [
    { correction: 0, checkId: 'check', capturedAt: '2026-09-21T00:00:00Z', offsetArcminutes: 42.4, rotationDegrees: 180, pointingSide: 'west', pointingSideChanged: false, trend: 'starting' },
  ] },
}
...
describe('framing transport validation', () => {
  ...
  it('rejects malformed progress before it can render or enable commands', () => {
    for (const invalid of [
      ...
      { centering: { ...view.centering, measurements: [{ ...view.centering!.measurements[0], correction: 2 }] } },
      { centering: { ...view.centering, measurements: [{ ...view.centering!.measurements[0], offsetArcminutes: -1 }] } },
      { centering: { ...view.centering, measurements: [{ ...view.centering!.measurements[0], pointingSideChanged: 'yes' }] } },
