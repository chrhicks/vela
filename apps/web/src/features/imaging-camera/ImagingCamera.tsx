...
export function ImagingCamera({
  ...
  return (
    <Panel className="vela-imaging-camera" aria-label="Imaging camera">
        ...
        >
          <Select
            ...
            options={[
              ...
              ...view.cameras.map(item => ({
                value: item.id,
                label: item.name
                  ? `${item.name} · ${item.configuredName}`
                  : `${item.configuredName} · Identity unavailable`,
          ...
          <div className="vela-imaging-camera__actions">
            ...
            {selected && (
              <Button
                type="button"
                tone="quiet"
                disabled={pending || camera.unconfirmed}
                onClick={() => {
                  setChoice(null)
                  setEditing(false)
                }}
