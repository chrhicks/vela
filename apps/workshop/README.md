...
- A draft visual target-selection and framing sketch with locally bundled reference photographs, instant sample search, illustrative sky paths, a movable fixed-orientation camera frame, and simulated slew/check/adjust states. Its Through the night sidebar expands into an overhead sky view with shared time and elevation-margin controls. Optional synthetic horizon profiles demonstrate complete, incomplete and provisional coverage. It does not calculate real visibility or control devices.
