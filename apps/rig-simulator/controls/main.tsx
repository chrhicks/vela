      ...
      {state && <div className="sim-layout">
        ...
        <div className="sim-side">
          <Panel title="Cameras" description="Choose each camera’s image size for the next exposure.">
            {state.cameras.map(camera => <section
          ...
          <Panel title="Shared sky" description="Both cameras see the same sky and mount position.">
            <div className="sim-camera">
              ...
              <p>{state.obscured ? 'New exposures contain background noise without stars.' : 'New exposures contain the generated star field.'}</p>
            </div>
            <Button
              tone="neutral"
              disabled={blocked}
