    ...
    <div className="vela-navigation">
      <header className="vela-navigation__bar">
        <div className="vela-navigation__context">
          <a className="vela-navigation__brand" href={home.href} aria-label="Vela · all rigs" onClick={home.onClick}>
            V
            <span>ela</span>
          </a>
        ...
        {activity && (
          ...
          >
            <span className="vela-navigation__capture-summary">
              <span>{activity.rigName && <small>{activity.rigName} · </small>}{activity.completedCount} captured</span>
