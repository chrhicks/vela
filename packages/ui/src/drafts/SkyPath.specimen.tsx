...
import { getDemoHorizon, getSkySamples } from './sky-path/fixtures'
...
export const specimen: ComponentSpecimen = {
  ...
  defaultProps: { target: 'andromeda', horizon: 'none', selectedIndex: 18, marginDegrees: 3, compact: false, empty: false },
