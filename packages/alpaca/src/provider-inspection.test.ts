...
describe('Alpaca device inspection', () => {
  it('normalizes the status required by each current device kind', async () => {
    ...
    await expect(provider.inspectDevices()).resolves.toEqual([
      ...
      {
        providerDeviceId: 'focuser-0',
        kind: 'focuser',
        configuredName: 'Focuser slot',
        name: 'Focuser hardware',
        connection: 'connected',
        telemetry: {
          availability: 'complete',
          values: {
      ...
      {
        providerDeviceId: 'filterwheel-0',
        kind: 'filter-wheel',
        configuredName: 'FilterWheel slot',
        name: 'FilterWheel hardware',
        connection: 'connected',
        telemetry: {
          availability: 'complete',
          values: {
      ...
      },
      {
        ...
        name: 'ObservingConditions hardware',
        connection: 'connected',
        telemetry: {
          availability: 'complete',
          values: {
